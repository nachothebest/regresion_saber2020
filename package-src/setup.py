...
NAME = 'model-saber2020'
DESCRIPTION = "Empaquetamiento del Modelo de Regresion que permite predecir el puntaje de las pruebas Saber"
URL = ""
EMAIL = "j.rengifov@uniandes.edu.co"
AUTHOR = "joserengifo"
